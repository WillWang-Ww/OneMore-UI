...

{
  ...
  var _useElement2 = _vm2.$el.querySelector('use');

  var _href2 = _useElement2.getAttribute('xlink:href');

  expect(_href2).to.eq('#icon-check');
...

{
  ...
  var spy = _chai.default.spy(function () {}); //设置一个空的间谍函数
...
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","chai":"node_modules/chai/index.js","chai-spies":"node_modules/chai-spies/chai-spies.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
